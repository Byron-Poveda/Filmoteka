var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},t={},i={},a=e.parcelRequired76b;null==a&&((a=function(e){if(e in t)return t[e].exports;if(e in i){var a=i[e];delete i[e];var r={id:e,exports:{}};return t[e]=r,a.call(r.exports,r,r.exports),r.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){i[e]=t},e.parcelRequired76b=a);var r=a("2shzp"),s=a("jvSt7"),l=a("kU0MA"),n=a("iccHK");const o=document.getElementById("idInputSearch"),c=document.getElementById("idSearchList"),p=document.querySelector("#idSearchButton"),d=document.querySelector(".list_api"),u=document.getElementById("listPages");let f=1,v=[];o.addEventListener("input",e=>{c.innerHTML="",e.target.value&&(0,r.default).get(`https://api.themoviedb.org/3/search/movie?api_key=${s.apiKey}&query=${e.target.value}&include_adult=false&include_video=false&sort_by=popularity.desc`).then(e=>{if(!e.data.results.length)return alert("no se encontro la pelicula buscada");e.data.results.forEach(e=>{e.genre_ids.forEach(e=>{(0,n.genres).forEach(t=>{e===t.id&&v.push(t.name)})});let t=v.join(", ");c.insertAdjacentHTML("beforeend",`<li class="search__item" id="idSearchItem">
...
//# sourceMappingURL=index.cf267c5d.js.map
